...
public class TestConfig {
	...
	public static String from = "nayangogoi744@gmail.com";
	public static String password = null;
	public static String[] to ={"nayangogoi744@gmail.com","nivakalita744@gmail.com"};
	public static String subject = "Latest Extent Report";
